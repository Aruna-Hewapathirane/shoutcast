...
class PreferencesShoutcastDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesShoutcastDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesShoutcastDialog object.
        """
        builder = get_builder('PreferencesShoutcastDialog')
        new_object = builder.get_object("preferences_shoutcast_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesShoutcastDialog object with it in order to
        finish initializing the start of the new PerferencesShoutcastDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesShoutcastDialog()
    dialog.show()
    gtk.main()
